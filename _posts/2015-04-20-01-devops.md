...
The next thing you'll need are some scripts, these are all in the `dcycle` folder (if you're interested, they come from [this project](http://box.dcycle.com/); if you have downloaded a previous versionof DcycleU, this folder was named `scripts`.

 * [See the contents of the dcycle folder here](https://github.com/dcycleproject/dcycleu/blob/gh-pages/scripts/build-dev.sh).
