 ...
 * `Dockerfile-dcycle-jekyll`, a file which describes how to build a Jekyll server.
 * `Dockerfile-dcycle-jekyll-test`, same as above but tailored for testing.
 * `Dockerfile-dcycle-nginx`, a file which describes how to build a webserver.
 ...
 * `Dockerfile-dcycle-jekyll`.
 * `Dockerfile-dcycle-jekyll-test`.
 * `Dockerfile-dcyle-nginx`.
 * `dcycle` (a folder).
